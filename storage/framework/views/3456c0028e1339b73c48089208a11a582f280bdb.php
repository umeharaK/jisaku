...
<div class="container my-5 text-center w-50" id="contact">
      ...
      <form  action="<?php echo e(route('edit_comp',['id' => $inputs['id']])); ?> " method="post">
      <?php echo csrf_field(); ?>
          <div class="form-group text-left row">

          <input type="hidden" class="form-control col-10" id="formGroupExampleInput" name='id' value="<?php echo e($inputs['id']); ?>">
...
</html><?php /**PATH C:\MAMP\htdocs\RodentGarden\resources\views/post_edit_conf.blade.php ENDPATH**/ ?>