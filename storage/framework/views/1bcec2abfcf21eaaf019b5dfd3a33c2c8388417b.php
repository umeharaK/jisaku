...
<div class="form-group row justify-content-around">
      ...
      <a class="btn btn-success col-2" href="<?php echo e(route('index')); ?>">
   ...
   <div class="container my-5" id="skill">
      <h2 class= "py-4 text-dark">お気に入り一覧</h2>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\RodentGarden\resources\views/likelist.blade.php ENDPATH**/ ?>